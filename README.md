...
**Tested on Gradle versions from <!--property:gradle-api.min-version-->8.0<!--/property--> to <!--property:gradle-api.max-version-->9.2.0<!--/property-->.**
...
```groovy
plugins {
    id 'name.remal.github-repository-info' version '1.0.0-rc-3'
}
```
<!--/plugin-usage-->
